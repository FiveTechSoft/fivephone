...
function Main()
   ...
   local oWnd := TWindow():New(), osegment
   
    osegment = TSegment():New( oWnd, 77, 50, 207, 44 )
...
local oView:=tView():resources(ownd,"segment")
local oTab


local osegment := tSegment():resources(oView,55)
