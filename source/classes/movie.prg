...
CLASS TMoviePlayer FROM TView
     
   METHOD New( oWnd, cFileName, nTop, nLeft, nWidth, nHeight )
   
   METHOD Play() INLINE MoviePlay( ::hWnd )
       
ENDCLASS

//--------------------------------------------------------------------//

METHOD New( oWnd, cFileName, nTop, nLeft, nWidth, nHeight ) CLASS TMoviePlayer

   DEFAULT nTop := 50, nLeft := 50, nWidth := 200, nHeight := 200 
   
   ::hWnd = CreateMoviePlayer( oWnd:hWnd, cFileName, nTop, nLeft, nWidth, nHeight )
