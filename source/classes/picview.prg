...
CLASS TPickerView FROM TView
   
   METHOD New( oWnd, aItems, nTop, nLeft, nWidth, nHeight )
   METHOD Resources( oWnd, idResource, aItems )
    
ENDCLASS

METHOD New( oWnd, aItems, nTop, nLeft, nWidth, nHeight ) CLASS TPickerView

   ::hWnd = CreatePickerView( oWnd:hWnd, aItems, nTop, nLeft, nWidth, nHeight )
...
METHOD Resources( oWnd, idResource, aItems ) CLASS TPickerView
  
   ::hWnd = GetControlResource( oWnd:hWnd,idResource )  
   CreatePickerResources(::hWnd,aItems )
   AAdd( GetAllWin(), Self )
