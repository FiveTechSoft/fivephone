...
function Main()
   ...
   local oBtn   
    ...
    oBtn = TButton():New( oWnd, "Button " , 30, 10, 100, 40 , {|| Btn(ownd) } ) 
...
local oView:=tView():resources(ownd,"resbutton")
local obtn:=tButton():resources(oView, 55, {|| MsgInfo("Launch Action") })

   oBtn:SetText( "Button Test" )
