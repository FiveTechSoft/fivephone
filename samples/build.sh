...
arm-apple-darwin-gcc $1.c -c -I./../../harbour/include
 
echo linking...
arm-apple-darwin-gcc $1.o -o $1 -L./../lib -lfive -lfivec -L./../../harbour/lib -ldebug -lvm -lrtl -llang -lrdd -lgttrm -lgtstd -lrtl -lvm -lmacro -ldbfntx -ldbfcdx -ldbffpt -lhbsix -lcommon \
...
echo copying to the iPhone...
scp ./$1 root@192.168.0.xxx:/Applications/fivephone.app/test
ssh root@192.168.0.xxx killall SpringBoard